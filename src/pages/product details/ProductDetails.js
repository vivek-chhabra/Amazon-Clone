...
import { capitalize, numDivisibleBy, randNum } from "../../helpers";
...
export default function ProductDetails() {
    ...
    // useInput hook
    const [quantity, setQuantity] = useInput(0);

    // useFirestore hook
    const { response, addDocument, deleteDocument, editDocument } = useFirestore();
